...
def CompareBasePositions(query_sam, ref_sam, switch_ins_and_dels=False):
	num_mapped_bases = query_sam.CalcReadLengthFromCigar() - query_sam.clip_count_front - query_sam.clip_count_back;
	num_ref_bases = ref_sam.CalcReadLengthFromCigar() - ref_sam.clip_count_front - ref_sam.clip_count_back;

        if (query_sam.CalcReadLengthFromCigar()  !=  ref_sam.CalcReadLengthFromCigar()):
               print query_sam.CalcReadLengthFromCigar()
               print ref_sam.CalcReadLengthFromCigar()
               return [0, 0, 0];
