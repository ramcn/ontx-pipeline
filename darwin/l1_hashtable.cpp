...
unsigned long long int Hashtable::get_frequency_address(uint64_t hash){
  return (unsigned long long int) &hashtable[hash].frequency;
}
...
unsigned long long int Hashtable::get_offset_address(uint64_t hash){
  return (unsigned long long int) &hashtable[hash].offset;
}
...
unsigned long long int Hashtable::get_location_address(uint32_t index){
  return (unsigned long long int) &locations[index];
}
